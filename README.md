...
- Database dari 3 sumber – Windows, Android, dan Linux malware signature
...
XScanner mengambil signature dari tiga sumber utama:

- theZoo – Database malware Windows (10.000+ signature)
- Android Malware DB – Database malware Android (5.000+ signature)
- Signature Base – Database malware Linux (3.000+ signature)
- Cobalt Strike Parser – Signature Cobalt Strike C2 (1.000+ signature)
...
Hasil scan deep akan disimpan di folder reports dengan format:
```

deep_scan_20260326_120000.log
